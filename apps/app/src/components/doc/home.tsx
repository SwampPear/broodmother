...
const KEYS: { key: string; does: string }[] = [
  ...
  {
    key: '⌘⇧S',
    does: 'Commit and sync the vault now, without waiting on the idle timer',
  },
]

/** What a vault with nothing open shows: the mark, the name, and the keys. None of it is a
