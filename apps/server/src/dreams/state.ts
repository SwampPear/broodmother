 ...
 * by dream and node. On disk rather than in memory so a restarted server picks up where
...
export class TriggerStore {
  ...
  /** Drops cursors for triggers that no longer exist, so the file tracks the dreams. */
